...
class WatchdogManager:
    ...
    def __init__(self, controller):
        ...
        self.watchdogs = {
            'main': SystemWatchdog('main', timeout=600),
            'temperature': SystemWatchdog('temperature', timeout=300),
            'control': SystemWatchdog('control', timeout=60),
            'display': SystemWatchdog('display', timeout=120),
            'lora': SystemWatchdog('lora', timeout=3600)
        }
