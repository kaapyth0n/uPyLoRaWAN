...
class ConfigurationManager:
	...
	def __init__(self):
		...
		self.parameter_definitions = {'mode': {'id': 0, 'type': str, 'allowed_values': ['relay', 'sensor', 'pid', 'soft_pid', 'ntc10k'], 'default': 'relay'}, 'setpoint': {'id': 1, 'type': float, 'min': 0, 'max': 100, 'default': BoilerDefaults.DEFAULT_TEMP}, 'min_temp': {'id': 2, 'type': float, 'min': 0, 'max': 100, 'default': BoilerDefaults.MIN_TEMP}, 'max_temp': {'id': 3, 'type': float, 'min': 0, 'max': 100, 'default': BoilerDefaults.MAX_TEMP}, 'hysteresis': {'id': 4, 'type': float, 'min': 0.1, 'max': 25.0, 'default': BoilerDefaults.HYSTERESIS}, 'min_on_time': {'id': 5, 'type': int, 'min': 1, 'max': 300, 'default': BoilerDefaults.MIN_ON_TIME}, 'min_off_time': {'id': 6, 'type': int, 'min': 1, 'max': 300, 'default': BoilerDefaults.MIN_OFF_TIME}, 'watchdog_timeout': {'id': 7, 'type': int, 'min': 60, 'max': 7200, 'default': BoilerDefaults.WATCHDOG_TIMEOUT}, 'lora_keepalive': {'id': 8, 'type': int, 'min': 1, 'max': 3600, 'default': 300}, 'pid_max_volts': {'id': 9, 'type': float, 'min': 0.0, 'max': 22.5, 'default': 22.5}, 'pid_kp': {'id': 10, 'type': float, 'min': 0.0, 'max': 100.0, 'default': 1.0}, 'pid_ki': {'id': 11, 'type': float, 'min': 0.0, 'max': 100.0, 'default': 0.1}, 'pid_kd': {'id': 12, 'type': float, 'min': 0.0, 'max': 100.0, 'default': 0.01}, 'devaddr': {'id': 13, 'type': str, 'default': '00000000', 'description': 'LoRaWAN Device Address (hex format)', 'validator': self._validate_hex_string, 'format': 'hex', 'hex_length': 4}, 'pid_min_volts': {'id': 14, 'type': float, 'min': 0.0, 'max': 22.5, 'default': 0.0, 'description': 'PID minimum output voltage limit'}, 'update_branch': {'id': 15, 'type': str, 'default': 'lora_2512_o', 'description': 'GitHub branch to check for updates'}, 'pid_kp_std': {'id': 16, 'type': float, 'min': 0.01, 'max': 100.0, 'default': 1.0, 'description': 'PID Proportional Gain (standard form)'}, 'pid_ti_std': {'id': 17, 'type': float, 'min': 0.1, 'max': 10000.0, 'default': 600.0, 'description': 'PID Integral Time Constant (standard form)'}, 'pid_td_std': {'id': 18, 'type': float, 'min': 0.0, 'max': 10000.0, 'default': 600.0, 'description': 'PID Derivative Time Constant (standard form)'}, 'pid_dt': {'id': 19, 'type': float, 'min': 0.1, 'max': 1000.0, 'default': 10.0, 'description': 'PID Control Interval (seconds)'}, 'simulated_temp': {'id': 20, 'type': float, 'min': -40.0, 'max': 100.0, 'default': 20.0, 'description': 'Simulated outdoor temperature for NTC10k mode (°C)'}, 'direct_resistance': {'id': 21, 'type': float, 'min': 901.0, 'max': 100000.0, 'default': 10000.0, 'description': 'Direct resistance value for sensor mode (Ohms)'}, 'outdoor_sensor_type': {'id': 22, 'type': str, 'allowed_values': ['ntc10k', 'ntc5k', 'pt1000', 'ds18b20', 'disabled'], 'default': 'ntc10k', 'description': 'Outdoor temperature sensor type on IO1 LN_2 input'}}
		self.id_to_param = {}
